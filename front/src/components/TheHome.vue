    ...
    <div class="header">
      <div class="container">
        <ul class="nav">
          ...
          <li><router-link class="x" to="/gift"> gift </router-link></li>
        </ul>
      </div>
    </div>
        ...
        <div class="main">
          ...
          <form @submit.prevent="login">
            <label for="">
              ...
              <br><input class="inpt" type="password" placeholder="Enter Your Password" v-model="Password"> 
            </label>
          <br>
          <label for="">
...
/* html, body {
  ...
  .jumbotron {
    background: url(https://newsimg.hankookilbo.com/cms/articlerelease/2022/05/09/d3880fc3-314b-43cc-b89f-b70e08fc7f8d.jpg);
